...
var scriptVersion = 1361935568652; // 27 Feb 2013
...
function scriptChannelMain() {
	...
	playerDiv.addEventListener("DOMNodeInserted", function(evt) {
		var targetId = evt.target.id;
		if ((targetId === YT_PLAYER_CHANNEL_ID_FLASH) || (targetId === YT_PLAYER_CHANNEL_ID_HTML5)) channelPlayerInsertion(targetId);
	}, false);
